...
module Tutorial
  class Application < Hanami::Application
    configure do
      ...
      #
      # sessions :cookie, secret: ENV['TUTORIAL_SESSIONS_SECRET']
      ...
      #
      layout :application # It will load Tutorial::Views::ApplicationLayout
      ...
      # Configure the code that will yield each time Tutorial::Action is included
      ...
      # Configure the code that will yield each time Tutorial::View is included
      # This is useful for sharing common functionality
      #
      # See: http://www.rubydoc.info/gems/hanami-view#Configuration
      view.prepare do
        include Hanami::Helpers
        include Tutorial::Assets::Helpers
      end
    end
